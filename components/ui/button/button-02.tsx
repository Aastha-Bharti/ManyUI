...
export default function Btn({ children, className, onClick }: ButtonPropType) {
  return (
    <button className="px-12 py-2 bg-zinc-700 dark:bg-black border dark:text-white text-white rounded-md relative cursor-pointer group overflow-visible transition-all duration-300">
